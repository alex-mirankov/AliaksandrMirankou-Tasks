class UI {
    renderCalendar() {
        ...
        navigation_button_left.style.outline = "none";
        navigation_button_left.style.cursor = "pointer";
    ...
    renderOtherMonth(currentMonth) {
        ...
        for (var i = 0; i < 6; i++) {
            ...
            for (var j = 0; j < 7; j++) {
                ...
                if (String(objectDOM.navigation_month.textContent) === String(objectArrays.monthNamesArray[objectDate.currentMonth])
